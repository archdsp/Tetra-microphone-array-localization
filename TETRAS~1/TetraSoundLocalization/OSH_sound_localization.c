...
double cord3_trans(double *planes_azimuth, double *planes_elevation, double *s_theta_all, double *s_piangle_all, int angle_range, double mic_distance)
{
	...
	double osh_th, osh_pi;
	int i, k, data_tune, data_len = 0, ret_cnt;
	...
	osh11[0] = osh1[0]; osh11[1] = -1 * osh1[1];
	...
	osh2[0] = planes_azimuth[2]; osh2[1] = planes_elevation[2];
	...
	osh21[0] = osh2[0]; osh21[1] = -1 * osh2[1];
	...
	osh3[0] = planes_azimuth[3]; osh3[1] = planes_elevation[3];
	...
	osh31[0] = osh3[0]; osh31[1] = -1 * osh3[1];
	...
	ga = mic_distance / sqrt(3.0);
	a_axisp[0] = ga / 2; a_axisp[1] = 0; a_axisp[2] = 0;
	a_axism[0] = -1 * ga / 2; a_axism[1] = 0; a_axism[2] = 0;
	...
	dir0[0] = osh0[0]; dir0[1] = osh0[1];
	dir01[0] = osh0[0]; dir01[1] = -1 * osh0[1];

	x = tr_out1[0];            y = tr_out1[1];            z = tr_out1[2];
	...
	x = tr_out2[0];            y = tr_out2[1];            z = tr_out2[2];
	...
	x = tr_out21[0];            y = tr_out21[1];            z = tr_out21[2];
	...
	x = tr_out3[0];            y = tr_out3[1];            z = tr_out3[2];
	...
	x = tr_out31[0];            y = tr_out31[1];            z = tr_out31[2];
	...
	if (dir_th_0p_1p != 999 && dir_pi_0p_1p != 999)
	{
		ret_cnt = ret_cnt + 1;
	...
	if (dir_th_0p_1m != 999 && dir_pi_0p_1m != 999)
	{
		ret_cnt = ret_cnt + 1;
	...
	if (dir_th_0p_2p != 999 && dir_pi_0p_2p != 999)
	{
		ret_cnt = ret_cnt + 1;
	...
	if (dir_th_0p_2m != 999 && dir_pi_0p_2m != 999)
	{
		ret_cnt = ret_cnt + 1;
	...
	if (dir_th_0p_3p != 999 && dir_pi_0p_3p != 999)
	{
		ret_cnt = ret_cnt + 1;
	...
	if (dir_th_0p_3m != 999 && dir_pi_0p_3m != 999)
	{
		ret_cnt = ret_cnt + 1;
	...
	if (dir_th_0m_1p != 999 && dir_pi_0m_1p != 999)
	{
		ret_cnt = ret_cnt + 1;
	...
	if (dir_th_0m_1m != 999 && dir_pi_0m_1m != 999) {
		ret_cnt = ret_cnt + 1;
		th_array[ret_cnt] = dir_th_0m_1m;                   pi_array[ret_cnt] = dir_pi_0m_1m;
	}
	...
	if (dir_th_0m_2p != 999 && dir_pi_0m_2p != 999) {
		ret_cnt = ret_cnt + 1;
		th_array[ret_cnt] = dir_th_0m_2p;                   pi_array[ret_cnt] = dir_pi_0m_2p;
	}
	...
	if (dir_th_0m_2m != 999 && dir_pi_0m_2m != 999) {
		ret_cnt = ret_cnt + 1;
		th_array[ret_cnt] = dir_th_0m_2m;                   pi_array[ret_cnt] = dir_pi_0m_2m;
	}
	...
	if (dir_th_0m_3p != 999 && dir_pi_0m_3p != 999) {
		ret_cnt = ret_cnt + 1;
		th_array[ret_cnt] = dir_th_0m_3p;                   pi_array[ret_cnt] = dir_pi_0m_3p;
	}
	...
	if (dir_th_0m_3m != 999 && dir_pi_0m_3m != 999) {
		ret_cnt = ret_cnt + 1;
		th_array[ret_cnt] = dir_th_0m_3m;                   pi_array[ret_cnt] = dir_pi_0m_3m;
	}
	///////////////////////////////////////
	...
	if (dir_th_1p_2p != 999 && dir_pi_1p_2p != 999) {
		ret_cnt = ret_cnt + 1;
		th_array[ret_cnt] = dir_th_1p_2p;                   pi_array[ret_cnt] = dir_pi_1p_2p;
	}
	...
	if (dir_th_1p_2m != 999 && dir_pi_1p_2m != 999) {
		ret_cnt = ret_cnt + 1;
		th_array[ret_cnt] = dir_th_1p_2m;                   pi_array[ret_cnt] = dir_pi_1p_2m;
	}
	...
	if (dir_th_1p_3p != 999 && dir_pi_1p_3p != 999) {
		ret_cnt = ret_cnt + 1;
		th_array[ret_cnt] = dir_th_1p_3p;                   pi_array[ret_cnt] = dir_pi_1p_3p;
	}
	...
	if (dir_th_1p_3m != 999 && dir_pi_1p_3m != 999) {
		ret_cnt = ret_cnt + 1;
		th_array[ret_cnt] = dir_th_1p_3m;                   pi_array[ret_cnt] = dir_pi_1p_3m;
	}
	...
	if (dir_th_1m_2p != 999 && dir_pi_1m_2p != 999) {
		ret_cnt = ret_cnt + 1;
		th_array[ret_cnt] = dir_th_1m_2p;                   pi_array[ret_cnt] = dir_pi_1m_2p;
	}
	...
	if (dir_th_1m_2m != 999 && dir_pi_1m_2m != 999) {
		ret_cnt = ret_cnt + 1;
		th_array[ret_cnt] = dir_th_1m_2m;                   pi_array[ret_cnt] = dir_pi_1m_2m;
	}
	...
	if (dir_th_1m_3p != 999 && dir_pi_1m_3p != 999) {
		ret_cnt = ret_cnt + 1;
		th_array[ret_cnt] = dir_th_1m_3p;                   pi_array[ret_cnt] = dir_pi_1m_3p;
	}
	...
	if (dir_th_1m_3m != 999 && dir_pi_1m_3m != 999) {
		ret_cnt = ret_cnt + 1;
		th_array[ret_cnt] = dir_th_1m_3m;                   pi_array[ret_cnt] = dir_pi_1m_3m;
	}
	...
	if (dir_th_2p_3p != 999 && dir_pi_2p_3p != 999) {
		ret_cnt = ret_cnt + 1;
		th_array[ret_cnt] = dir_th_2p_3p;                   pi_array[ret_cnt] = dir_pi_2p_3p;
	}
	...
	if (dir_th_2p_3m != 999 && dir_pi_2p_3m != 999) {
		ret_cnt = ret_cnt + 1;
		th_array[ret_cnt] = dir_th_2p_3m;                   pi_array[ret_cnt] = dir_pi_2p_3m;
	}
	...
	if (dir_th_2m_3p != 999 && dir_pi_2m_3p != 999) {
		ret_cnt = ret_cnt + 1;
		th_array[ret_cnt] = dir_th_2m_3p;                   pi_array[ret_cnt] = dir_pi_2m_3p;
	}
	...
	if (dir_th_2m_3m != 999 && dir_pi_2m_3m != 999) 
	{
		ret_cnt = ret_cnt + 1;
	...
	planes_azimuth[4] = osh_th / (ret_cnt + 1);
	planes_elevation[4] = osh_pi / (ret_cnt + 1);

	s_theta_all[0] = dir0[0];
	s_theta_all[1] = dir01[0];
	s_theta_all[2] = dir1[0];
	s_theta_all[3] = dir11[0];
	s_theta_all[4] = dir2[0];
	s_theta_all[5] = dir21[0];
	s_theta_all[6] = dir3[0];
	s_theta_all[7] = dir31[0];
