...
double cord3_trans(double *side_plane_based_azimuth, double *side_plane_based_elevation, 
	double *s_theta_all, double *s_piangle_all, int angle_range, double mic_distance);
